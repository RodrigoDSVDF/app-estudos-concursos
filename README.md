# Aprovado — Estudos para Concursos

Aplicativo web **PWA** (HTML5 + CSS3 + JavaScript puro) para gerenciamento e otimização de estudos para concursos públicos. Funciona diretamente no **GitHub Pages** com **login Google** e **Supabase** como backend. Cada usuário tem seus dados isolados.
...
O Aprovado é um **Progressive Web App** (PWA). Isso significa que você pode instalá-lo no celular ou desktop como se fosse um aplicativo nativo:

### No Android (Chrome)
1. Abra a URL do app no Chrome
2. Toque no menu (⋮) no canto superior direito
3. Selecione **"Adicionar à tela inicial"** ou **"Instalar app"**
4. Confirme — o app aparecerá na sua lista de aplicativos
...
1. Abra a URL do app
2. Clique no ícone **⊕ Instalar** na barra de endereços (ou menu → Instalar Aprovado)
3. Confirme — o app abrirá em janela própria, sem barra de endereço

### Vantagens do PWA
- 📲 **Ícone na tela inicial** como app nativo
- 🚀 **Abre em tela cheia** (sem barra do navegador)
- ⚡ **Funciona offline** — assets críticos são cacheados
- 🔄 **Atualiza automaticamente** quando há nova versão
- 💾 **Persistência**: dados ficam no Supabase, acessíveis de qualquer dispositivo
- 🆓 **Sem App Store** — sem taxa de publicação, sem revisão
