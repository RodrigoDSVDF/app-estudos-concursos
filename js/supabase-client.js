...
function getSupabase() {
  ...
  _supabaseClient = window.supabase.createClient(SUPABASE_URL, SUPABASE_ANON_KEY, {
    auth: {
      ...
      storageKey: 'aprovado-auth',
      flowType: 'implicit'         // FORÇA fluxo implícito (#access_token na URL)
                                   // Mais compatível com PWA/GitHub Pages que PKCE
    },
    db: {
      schema: 'public'
    },
    global: {
      headers: { 'X-Client-Info': 'aprovado-web/2.0' }
    }
  });
